# DeRec Alliance Contributing Guidelines

The DeRec Alliance is grateful for any contributions it receives from the community. Contributions can come in many shapes and forms including code, answering questions on Github, bug reports, etc. This document outlines the process to help get your contribution accepted.

## Issues

GitHub [issues](https://docs.github.com/en/issues) are used as the primary method for tracking project changes. Issues should track actionable items that will result in changes to the codebase.

### Vulnerability Disclosure

Most of the time, when you find a bug, it should be reported the GitHub issue tracker for the project. However, if you are reporting a _security vulnerability_, please contact security@derecalliance.org.
...
```sh
$ git remote add upstream https://github.com/derecalliance/${repo}.git
```
...
The DeRec Alliance uses [Semantic Versioning](https://semver.org) for releases to convey meaning about the underlying code and what
...
If you have a question on how to use the product, please reach out to contact@derecalliance.org.
